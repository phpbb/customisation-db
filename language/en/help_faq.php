...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_VALIDATORS_ANSWER'        => 'If it is an extension it will be validated by the Extension Team and Junior Validators or occassionally a Development Team Member. For a style it will be validated by the Style Customisations Team and Junior Style Validators. For a convertor it will be validated by a Support or Development Team Member. For a bridge it will be validated by an Extension or Development Team Member. Language Packs are all checked by the International Manager. Official Tools are tested and created by the phpBB.com Teams.',
));
