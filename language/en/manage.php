...
$lang = array_merge($lang, array(
	...
	'PHPBB_ROOT_PATH' 				=> 'Relative path to the phpBB installation.',
	'PHPBB_SCRIPT_PATH' 			=> 'Relative path from the server root (generate_board_url(true)).',
	'TITANIA_SCRIPT_PATH' 			=> 'Relative path from the server root (generate_board_url(true))',
	'TABLE_PREFIX' 					=> 'Prefix of the sql tables. Not the prefix for the phpBB tables, prefix for the Titania tables only. This MUST NOT be the same as the phpBB prefix!',
	'SEARCH_BACKEND' 				=> '',
	'FORUM_MOD_DATABASE' 			=> 'ID of MOD database forum',
	'FORUM_MOD_ROBOT' 				=> 'ID of user account used for topic/post release in MOD database forum.',
	'FORUM_EXTENSION_DATABASE' 		=> 'ID of Extensions database forum',
	'FORUM_EXTENSION_ROBOT' 		=> 'ID of user account used for topic/post release in Extensions database forum.',
	'FORUM_STYLE_DATABASE' 			=> 'ID of Styles database forum',
	'FORUM_STYLE_ROBOT' 			=> 'ID of user account used for topic/post release in Styles database forum.',
	'COLORIZEIT' 					=> 'ColorizeIt Config for Styles Section',
	'COLORIZEIT_AUTH' 				=> '',
	'COLORIZEIT_VAR' 				=> '',
	'COLORIZEIT_VALUE' 				=> '',
