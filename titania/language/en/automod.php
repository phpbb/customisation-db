...
$lang = array_merge($lang, array(
	...
	'AM_MOD_ALREADY_INSTALLED'				=> 'AutoMOD has detected this MOD is already installed and can not proceed.',
	...
	'AUTOMOD_INSTALLATION_EXPLAIN'			=> 'Welcome to the AutoMOD Installation.  You will need your FTP details if AutoMOD detects that is the best way to write files.  The test results are below.',
	...
	'CREATE_TABLE_EXPLAIN'					=> 'AutoMOD has successfully made the database alterations, including a permission which has been assigned to the “Full Administrator” role.',
	...
	'DEPENDENCY_INSTRUCTIONS'				=> 'The MOD you are trying to install depends on another MOD.  AutoMOD cannot detect if this MOD has been installed.  Please verify that you have installed <strong><a href="%1$s">%2$s</a></strong> before installing this MOD.',
	...
	'FILESYSTEM_NOT_WRITABLE'				=> 'AutoMOD has determined the filesystem is not writable, so the direct write method can not be used.',
	...
	'FTP_METHOD_ERROR'						=> 'There is no FTP method found, please check the AutoMod configuration for a correct FTP method.',
	...
	'FTP_METHOD_FTP'						=> 'FTP',
	'FTP_NOT_USABLE'						=> 'The FTP function can’t be used as it has been disabled by your hosting.',
	...
	'MODS_SETUP_INCOMPLETE'					=> 'A problem was found with your configuration and AutoMOD can not continue.  This should only occur when settings (e.g. FTP username) have changed and can be corrected in the AutoMOD configuration page.',
	...
	'ROOT_NOT_READABLE'						=> 'AutoMOD was not able to open phpBB’s index.php for reading.  This probably means that permissions are too restrictive on your phpBB root directory which will prevent AutoMOD from working.  Please adjust your permissions and try again.',
	...
	'UNINSTALLED_EXPLAIN'					=> 'The MOD has been uninstalled! Here you can view some of the results from the uninstallation. Please note any errors and seek support at <a href="http://www.phpbb.com">phpBB.com</a> if needed.',
