...
'MPV_TEST' => 'Next we will automatically test it against MPV and show you the results (this may take a few moments, so please be patient).<br /><br />Please hit continue when you are ready.',
...
'AUTOMOD_TEST' => 'Next we will automatically test it against Automod and show you the results (this may take a few moments, so please be patient).<br /><br />Please hit continue when you are ready.',
	...
	'CONTRIB_NONACTIVE_AUTHORS_EXPLAIN'	=> 'Nonactive co-authors can not manage anything for the contribution and are only listed as previous authors.',
	...
	'CONTRIB_PERMALINK_EXPLAIN'			=> 'Cleaned version of the contribution name, used to build the url for the contribution.',
