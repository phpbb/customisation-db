...
$help = array(
	...
	array(
		...
		1 => 'As with any customisation, authors are requested to follow certain guidelines when submitting their contribution.  The <a href="http://area51.phpbb.com/docs/coding-guidelines.html">Coding Guidelines</a>, though seemingly daunting at first, are actually your friend.  They should be followed as closely as possible to assist you in getting your contribution to the community published.  Please keep in mind that all customisations must pass the <a href="http://www.phpbb.com/mods/mpv/">phpBB MOD pre-validator</a> (aka “MPV”) and upon initial submission to Titania, will be first run against the program.  The script will check for things such as correct licensing, current phpBB version and current <a href="http://www.phpbb.com/mods/modx/">MODX</a> version.  If any of these items do not pass testing, your customisation will not be to be uploaded.  It behooves you to ensure that these items are checked for prior to submitting your customisation.'
	),
	array(
		0 => 'Submitting a Customisation',
		1 => 'So you’ve made a customisation.  Let’s get that puppy published!!  To submit a customisation, go to the <a href="http://www.phpbb.com/customise/db/">Customisation Database</a> and within that page you will find an image link that states “New Contribution”.  Once clicked on you will be able to enter in the customisation name, select the customisation type, add some wording to describe the customisation (smilies and bbcode is allowed), select the category(ies) that the customisation fits into, add co-authors (if any) and screenshots as well.  Please keep in mind that as you are submitting the customisation, it is your name the customisation will be aligned with.'
	),
	array(
	...
	array(
		...
		1 => 'Remember, every customisation MUST have the correct licensing (currenty GNU GPL version 2), the correct version of phpBB software and the correct MODX version.  Simply, if your customisation does not have these rudimentary items then, sadly, it will never be uploaded into the database.'
	),
	array(
		0 => 'My Customisation passed pre validation, now what?',
		1 => 'Once a customisation is accepted into the database, it is then up to the phpBB MOD Team and Junior Validators to validate your contribution.  You may find that you get a message stating your customisation was denied.  Please don’t fret.  We know things get overlooked or just simply missed.  Not to worry.  The message you may receive will contain items that were found.  These items may suggest changes to the code and may even suggest changes on “user friendliness”.  Generally speaking, “user friendliness” suggestions are just that...suggestions.  The most important part of any customisation is security, not in what it looks like to the end user.<br /><br />If no items were found during validation of your contribution you will also get a PM stating that your contribution has been accepted into the database.  It is now time to relax a bit and revel in the knowledge that you have made a contribution to the open source community.<br /><br />No matter the outcome of the validation, we at phpBB appreciate the time and effort you have exerted in sharing your contribution.'
	),	
);
