...
$help = array(
	...
	array(
		...
		1 => 'If it is a Modification it will be validated by the MOD Team and Junior Validators or occassionally a Development Team Member. For a style it will be validated by the Styles Team. For a convertor it will be validated by a Support or Development Team Member. For a bridge it will be validatd by a MOD or Development Team Member. Translations are all checked by the Translations & IST Manager, ameeck. Offical Tools are tested and created by the phpBB.com Teams.'
	),
);
