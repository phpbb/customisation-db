...
'CUSTOM_LICENSE' => 'Custom',
	...
	'CONTRIB_PERMALINK_EXPLAIN'				=> 'Versão limpa do nome da contribuição, usado para criar a url da contribuição.<br /><strong>Deixe em branco para ter um criado automaticamente com base no nome da contribuição.</strong>',
	...
	'MPV_RESULTS'							=> '<strong>Por favor, verifique os resultados do MPV e certifique-se de que nada precisa ser corrigido.<br /><br />Se você acha que nada precisa ser corrigido ou não tem certeza, apenas clique abaixo em continuar.</strong>',
	'MPV_TEST'								=> 'A MOD será testada com o MPV e os resultados serão exibidos (isto pode levar alguns minutos, portanto, seja paciente).<br /><br />Por favor, clique em continuar quando estiver pronto.',
	'MPV_TEST_FAILED'						=> 'Desculpe, o teste automático MPV falhou e os resultados do seu teste não estão disponíveis. Por favor, continue.',
	'MPV_TEST_FAILED_QUEUE_MSG'				=> 'Teste automático do MPV falhou. [url=%s]Clique aqui para tentar executar automaticamente o MPV novamente[/url]',
	...
	'NO_PHPBB_BRANCH'						=> 'Você deve selecionar uma branch do phpBB.',
	'NO_QUEUE_DISCUSSION_TOPIC'				=> 'Nenhuma fila de tópicos de discussões pôde ser encontrada. Você já enviou uma revisão para esta contribuição (ele será criado quando você fazer isso)?',
	...
	'PHPBB_BRANCH'							=> 'Branch phpBB',
	'PHPBB_BRANCH_EXPLAIN'					=> 'Selecione a branch phpBB que esta revisão suporta.',
	...
	'REVISION_NAME_EXPLAIN'					=> 'Digite um nome opcional para esta versão (ex.: Furry Edition)',
	'REVISION_NEW'							=> 'Novo',
	...
	'SELECT_PHPBB_BRANCH'					=> 'Selecione o branch phpBB',
	...
	'TOO_MANY_TRANSLATOR_LINKS'				=> 'Você está utilizando %d links externos dentro da linha TRANSLATION/TRANSLATION_INFO. Por favor inclua apenas <strong>um link</strong>. Incluir dois links é permitido analisando caso-a-caso - por favor, poste no fórum de traduções explicando suas razões para inserir mais links externos na linha.',
