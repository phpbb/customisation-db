...
[color=blue][b]A equipe do phpBB não é responsável nem obrigada a fornecer suporte à este estilo. Ao instalar esse estilo, você reconhece que a equipe de suporte do phpBB ou a equipe de estilos do phpBB podem não ser capazes de fornecer ajuda.[/b][/color]
...
// aos tradutores reordenar a saída de dados, assegurando que permaneçam corretos',
	...
	'STYLE_VALIDATION_MESSAGE_APPROVE'	=> 'Obrigado por enviar seu estilo para a Base de Customizações do phpBB. Após uma cuidadosa inspeção seu estilo foi aprovado e lançado em nossa Base de Customização.

Temos esperança de que você fornecerá um nível básico de suporte para este estilo e irá mantê-lo atualizado com futuras versões do phpBB. Apreciamos seu trabalho e sua contribuição para a comunidade. Autores como você fazem do phpBB um melhor lugar para todos.
