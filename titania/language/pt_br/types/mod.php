...
[b]Página de resumo da modificação:[/b] [url=%9$s]View[/url]

[color=blue][b]A equipe do phpBB não é responsável nem obrigada a fornecer suporte para esta modificação. Ao instalar esta MOD, você reconhece que a equipe de suporte do phpBB ou a equipe de modificações do phpBB podem não serem capazes de fornecer ajuda.[/b][/color]
...
[b]Download do arquivo[/b]: [url=%6$s]%7$s[/url]
[b]Tamanho do arquivo:[/b] %8$s Bytes',
	'MOD_REPLY_PUBLIC'					=> '[b][color=darkred]Modificação validade/lançada[/color][/b]',
...
Você também concorda e aceita que a licença desta MODificação e a licença de quaisquer componentes incluídos são compatíveis com a <a href="http://www.gnu.org/licenses/gpl-2.0.html">GNU GPLv2</a> e que você também permite a re-distribuição de sua MODificação através deste site indefinidamente. Para obter uma lista de licenças disponíveis e licenças compatíveis com a GNU GPLv2, por favor referencie-se pela <a href="http://en.wikipedia.org/wiki/List_of_FSF_approved_software_licenses">lista de licenças de softwares aprovadas pela FSF</a>.</span>',
	'MOD_VALIDATION'					=> '[Validação de MOD do phpBB] %1$s %2$s',
	'MOD_VALIDATION_MESSAGE_APPROVE'	=> 'Obrigado por enviar sua modificação para a phpBB.com Customisation Database. Após uma cuidadosa inspeção sua modificação foi aprovada e lançada em nossa Customisation Database.

Temos esperança de que você fornecerá um nível básico de suporte para esta modificação e irá mantê-la atualizada com futuras versões do phpBB. Apreciamos seu trabalho e sua contribuição para a comunidade. Autores como você fazem o phpBB.com um melhor lugar para todos.
...
Por favor, consulte os links a seguir antes de enviar novamente a sua modificação:
[list]
...
Para leitura auxiliar, talvez você queira rever o seguinte:
...
Para auxilio ao escrever MODs para o phpBB, os seguintes recursos existem:
[list][*][url=http://www.phpbb.com/community/viewforum.php?f=71]Forum for MOD Authors\Help[/url]
[*]Suporte no IRC - [url=irc://irc.freenode.net/phpBB-coding]#phpBB-coding[/url] é registrado na rede IRC FreeNode ([url=irc://irc.freenode.net/]irc.freenode.net[/url])[/list]

[b]Se desejar discutir qualquer coisa nesta MP, por favor, envie uma mensagem usando a aba discussão ina base de modificações, Minhas modificações, gerenciar esta MOD.[/b] Se você acha que esta recusa não possui justificativa, por favor contate o líder de validação de MODs.
