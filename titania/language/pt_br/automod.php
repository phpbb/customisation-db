...
$lang = array_merge($lang, array(
	...
	'GO_PHP_INSTALLER'						=> 'A MOD requer um instalador externo para concluir a instalação. Clique aqui para continuar para esta etapa.',

	'INHERIT_NO_CHANGE'						=> 'Nenhuma pôde ser efetuada neste arquivo porque a template %1$s depende da %2$s.',
	'INLINE_EDIT_ERROR'						=> 'Erro, uma edição na linha no arquivo de instalação MODX não possui nenhum dos elementos necessários',
	...
	'INSTALLED_EXPLAIN'						=> 'Sua MOD foi instalada! Aqui você pode ver alguns resultados da instalação. Ao notar quaisquer erros, procure suporte no <a href="http://www.phpbb.com">phpBB.com</a>',
	...
	'INSTALL_FORCED'						=> 'Você forçou a instalação desta MOD embora houvessem erros ao instalá-la. Seu fórum pode apresentar erros. Observe as ações em que houve falhas abaixo e tente corrigi-las.',
	...
	'MODS_CONFIG_EXPLAIN'					=> 'Você pode escolher como o AutoMOD ajusta seus arquivos aqui. O método mais básico é baixar arquivo comprimido. Os outros necessitam de permissões adicionais no servidor.',
	...
	'MOD_CONFIG_UPDATED'					=> 'Configuração do AutoMOD foi atualizada.',
