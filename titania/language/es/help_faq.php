...
$help = array(
	...
	array(
		0 => '¿Que es titania?',
		1 => 'Titania (también conocido como La base de modificaciones) es una base de datos donde los usuarios se podrán descargar las modificaciones y estilos para un foro phpBB. También se asegura que la modificación o el estilo que ha descargado ha superado los requisitos de validación phpBB.'
	),
	array(
		0 => '¿Validación? ¿Qué es eso?',
		1 => 'Todos y cada modificación, o el estilo, que se descarga por usted dentro de Titania han sido validados. Validación significa que una modificación, o el estilo, ha sido objeto de control en cuanto a la seguridad del código involucradas, así como pruebas para asegurar que se instala la modificación o el estilo y funciona correctamente en una versión particular de un foro phpBB. La validación le proporciona un nivel de comodidad de saber que no se descarga  la instalación de una modificación o estilo que puede suponer un problema de seguridad para su foro'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Hay varias maneras de encontrar una contribución. En la página principal de la base de datos usted puede ver las categorías que están actualmente disponibles, así como las modificaciones recientes y estilos que han sido aprobados dentro de la base de datos.'
	),
	array(
	...
	array(
		...
		1 => 'Así que usted ha hecho una contribución.  <br /> <br /> Para enviar una contribución, ir a la base de modificaciones y dentro de esa página encontrará un enlace de imagen que dice "Nueva Contribución". Una vez hecho clic, será capaz de introducir  el nombre de la contribución, seleccione el tipo de contribución, añadir un poco de texto para describir la contribución (emoticones y bbcode está permitido), seleccione la categoría (s) que la contribución se inscribe en, añadir co-autores (si procede) y capturas de pantalla también. Por favor, tenga en cuenta que a medida que se presenta la contribución, la contribución será presentada con su nombre.'
	),
	array(
