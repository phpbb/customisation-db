...
'CUSTOM_LICENSE' => 'Personalizar',
	...
	'ATTENTION_CONTRIB_CATEGORIES_CHANGED'	=> '<strong>Cambiada categoria de contribución</strong><br />%1$s<br /><br /><strong>to:</strong><br />%2$s',
	'ATTENTION_CONTRIB_DESC_CHANGED'		=> '<strong>Cambiar descipción de contribución:</strong><br />%1$s<br /><br /><strong>to:</strong><br />%2$s',
	...
	'AUTOMOD_TEST'							=> 'El Mod se pondrá a prueba contra AutoMod y los resultados se mostraran (esto puede tardar unos minutos, así que por favor sea paciente). <br /> <br /> Por favor, pulsa continuar cuando esté listo.',

	'BAD_VERSION_SELECTED'					=> '%s su versión de phpBB no esta actualizada.',

	'CANNOT_ADD_SELF_COAUTHOR'				=> 'Usted es el autor principal, no puede agregarse a la lista de coautores.',
    'CEASE_REQUEST'							=> 'Do not ask me again',
	'CLEANED_CONTRIB'						=> 'Limpiar contribución',
	'CONTRIB'								=> 'Contribución',
	'CONTRIBUTIONS'							=> 'Contribuciones',
	'CONTRIB_ACTIVE_AUTHORS'				=> 'Activar Co-Autores',
	'CONTRIB_ACTIVE_AUTHORS_EXPLAIN'		=> 'Activar Co-Autores, pueden activar la mayor parte de la contribución',
	...
	'CONTRIB_CATEGORY'						=> 'Categoría de contribución',
	...
	'CONTRIB_CONFIRM_OWNER_CHANGE'			=> '¿Está seguro que desea asignar como autor  a % s? Esto evitará que siga con la gestión del proyecto y no se puede deshacer.',
	...
	'CONTRIB_NEW'							=> 'Nuevo',
	'CONTRIB_NONACTIVE_AUTHORS'				=> 'No activar coautores (autores anteriores)',
	'CONTRIB_NONACTIVE_AUTHORS_EXPLAIN'		=> 'No activa co-autores, no pueden administrar  la contribución y sólo aparecen como autores anteriores.',
	'CONTRIB_NOT_FOUND'						=> 'No se encuentra la contribución solicitada',
	'CONTRIB_OWNER_UPDATED'					=> 'El autor ha sido cambiado.',
	'CONTRIB_PERMALINK'						=> 'Enlace permanente de contribución',
	'CONTRIB_PERMALINK_EXPLAIN'				=> 'Limpiar la versión del nombre de la contribución, que se utiliza para construir la URL de la contribución.<br /><strong>Dejar en blanco para crear automáticamente  un enlace basado en el nombre de la contribución.</strong>',
	...
	'EMPTY_CONTRIB_DESC'					=> 'Introduce la descripción de la contribución',
	'EMPTY_CONTRIB_ISO_CODE'				=> 'Ingresar código ISO ',
	'EMPTY_CONTRIB_LOCAL_NAME'				=> 'Introduzca el nombre local',
	'EMPTY_CONTRIB_NAME'					=> 'Introduce el nombre de la contribución',
	...
	'QUEUE_ALLOW_REPACK'					=> 'Permitir rehacer',
	...
	'TOO_MANY_TRANSLATOR_LINKS'				=> 'En este momento está usando % d los enlaces externos dentro de la traducción / línea TRANSLATION_INFO. Por favor, sólo incluya <strong> un enlace </ strong>. Incluye dos enlaces se permite en una base caso por caso - por favor, vaya al foro de traducciones y ponga sus razones para poner más enlaces externos dentro de la línea.',
