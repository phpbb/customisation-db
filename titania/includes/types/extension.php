...
class titania_type_extension extends titania_type_base
{
	...
	*/
	public function auto_install()
	{
		...
		if (!isset(phpbb::$config['titania_num_extensions']))
		{
			...
			$umil->permission_add(array(
				'u_titania_mod_extension_queue_discussion',
				'u_titania_mod_extension_queue',
				'u_titania_mod_extension_validate',
				'u_titania_mod_extension_moderate',
			));


			// Extension count holder
			$umil->config_add('titania_num_extensions', 0, true);
		}
	}
	...
	*/
	public function uninstall()
	{
		if (isset(phpbb::$config['titania_num_extensions']))
		{
			...
			// Mod count holder
			$umil->config_remove('titania_num_extensions');
		}
	}
}
