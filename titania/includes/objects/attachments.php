...
class titania_attachments extends titania_database_object
{
	...
	public function display_uploader($uploadify_settings = array(), $upload_scrip_params = array())
	{
		phpbb::$template->assign_vars(array(
			...
			'UPLOADER'		=> generate_board_url(true) . DIRECTORY_SEPARATOR . titania::$config->titania_script_path . 'js/uploadify/uploader.swf',
			'UPLOAD_SCRIPT'	=> generate_board_url(true) . DIRECTORY_SEPARATOR . append_sid(titania::$config->titania_script_path . 'upload.' . PHP_EXT, $upload_scrip_params),
		));
	}
