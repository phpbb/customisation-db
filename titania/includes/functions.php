...
/*
 * This is a test function only for MODs
 *
 * @param int $default
 * @param string $select_name
 * @return string
 */
function contrib_category_select($default = 0, $select_name = 'contrib_category')
{
	$sql = 'SELECT *
	...
	while ($category = phpbb::$db->sql_fetchrow($result))
	{
		...
		$selected = ($category['category_id'] == $default) ? ' selected="selected"' : '';
